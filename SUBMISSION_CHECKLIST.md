...
- Türkçe custom PDF test rehberi: `CUSTOM_PDF_GUIDE.md`
...
Hoca custom PDF testinden sonra orijinal 7 kanuna dönmek için `CENG493_Turkish_Legal_RAG_data.zip` içindeki `data/raw/` ve `data/processed/` klasörlerini proje köküne geri kopyalar. Detaylı adımlar: `CUSTOM_PDF_GUIDE.md`
...
- Custom PDF doküman koleksiyonu: `scripts/prepare_custom_pdfs.py`, `CUSTOM_PDF_GUIDE.md` ve `README.md`
- Custom benchmark testi: `src/evaluation/run_qa_eval.py --benchmark ...`
- Orijinal korpus geri yükleme: `CENG493_Turkish_Legal_RAG_data.zip` (içinden `data/raw/` + `data/processed/`)
...
6. Kısa not: Custom PDF testi için `CUSTOM_PDF_GUIDE.md`; orijinal korpus restore için `CENG493_Turkish_Legal_RAG_data.zip` belirtilmeli.
